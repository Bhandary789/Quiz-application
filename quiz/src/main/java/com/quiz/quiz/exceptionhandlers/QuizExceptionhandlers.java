package com.quiz.quiz.exceptionhandlers;

import com.quiz.quiz.exceptions.QuizException;
import com.quiz.quiz.exceptions.QuizSecurityException;
...
@ControllerAdvice
public class QuizExceptionhandlers extends ResponseEntityExceptionHandler {

    @ExceptionHandler(QuizSecurityException.class)
    public ResponseEntity<Object> handleSecurityException(QuizSecurityException ex) {
    ...
    public ResponseEntity<Object> handleCoffeeException(QuizException ex) {
        ErrorDto errorDto = ErrorDto.builder()
                .errorCode(ex.getErrorCode())
                .errorMessage(ex.getErrorMessage())
                .build();
